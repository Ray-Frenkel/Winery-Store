...
function HomeScreen() {
  ...
  return (
    <div>
      ...
      <p className="para">Wine is a popular alcoholic beverage that has been enjoyed for centuries. According to the International Organisation of Vine and Wine, global wine production in 2020 was 258 million hectoliters, with Italy, France, and Spain being the top three wine producing countries. The United States is the largest wine consuming country in the world, with Americans drinking over 3 billion liters of wine in 2020. Red wine is the most popular type of wine, accounting for 55% of total wine consumption worldwide, while white wine accounts for 35%. Rosé wine is also gaining popularity, with a 20% increase in consumption in the United States alone between 2019 and 2020. Wine has also been shown to have health benefits, with moderate wine consumption linked to a reduced risk of heart disease, stroke, and certain types of cancer.</p>
    </div>
  );
}
